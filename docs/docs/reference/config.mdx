...
### re_data:test_history_failures

Variable to enable/disable storing test failures. See [re_data tests history](/docs/reference/tests/history) for more details.

### re_data:test_history_failures_limit

Variable to configure failures stored per test. See [re_data tests history](/docs/reference/tests/history) for more details.
